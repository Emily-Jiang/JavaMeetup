...
This will create an executable jar file **talk.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/talk.jar
